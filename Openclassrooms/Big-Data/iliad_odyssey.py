...
def main():
    iliad = load_text("/Users/marcpartensky/Programs/Python/Machine-Learning/Openclassrooms/Big-Data/iliad.mb.txt")
    odyssey = load_text("/Users/marcpartensky/Programs/Python/Machine-Learning/Openclassrooms/Big-Data/odyssey.mb.txt")
    ...
    join_words = iliad.fullOuterJoin(odyssey)\
            .map(lambda word, freq: (word, (freq[1] or 0) - (freq[0] or 0)))
